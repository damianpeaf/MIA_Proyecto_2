...
from commands.service.own_bucket import OwnBucketService

base_file = OwnBucketService()
base_file.on_root = True

# LOCAL_BASE_PATH = base_file.get_file('/miausuarios.txt')
...
def validate_user(username: str = '', password: str = '') -> dict:
    ...
    lines: list[str] = base_file.get_file('/miausuarios.txt')['file_content'].split('\n')
